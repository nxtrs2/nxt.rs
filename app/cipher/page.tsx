  ...
  return (
    <div className="space-y-5 mb-24 m:mb-0">
      ...
      <div className="content-bg mt-1 prose prose-sm dark:prose-invert p-3 dark:bg-black dark:bg-opacity-60">
        ...
        <h2 className="text-xl font-heading mb-6">How it works</h2>
        <div className="grid gap-6">
          ...
          <p className="mb-2 leading-relaxed">
            ...
            groups—letters A–F and letters G–Z—and then reverses the order of
            the letters within each group. In the first group, the
            transformation maps A to F, B to E, C to D, D to C, E to B, and F to
            A. The second group follows a similar logic: G becomes Z, H becomes
            Y, I becomes X (hence, N<span className="text-green-400">X</span>
            TRS), continuing this pattern until Z is mapped to G. This method
            creates a mirror effect for each section of the alphabet. The cipher
            preserves the case of the original letters, so uppercase and
            lowercase letters are both translated into their respective reversed
            versions, while any non-alphabet characters remain unchanged.{" "}
          </p>
          <p className="mb-2 leading-relaxed">
            Unlike a traditional Caesar cipher—which uniformly shifts each
            character by a fixed number of positions—this cipher’s unique
            approach of splitting the alphabet into two segments makes it
            cooler. By handling the two segments separately, the cipher obscures
            the message and introduces an unexpected twist that can make
            decryption challenging without the proper key.
          </p>
        </div>
      </div>
    </div>
